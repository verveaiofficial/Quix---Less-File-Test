      ...
      <div className="input-wrapper" style={{ bottom: `${bottomOffset}px` }}>
        <div className="input-bar">
          ...
          <div className="action-row">
            ...
            <button
              className={`send-btn ${isDeepThink ? "" : isSending ? "stop" : ""}`}
              disabled={sendDisabled}
              onClick={isDeepThink || isSending ? stop : send}
              aria-label={isDeepThink || isSending ? "Stop" : "Send"}
            >
              {(isDeepThink || isSending) ? (
