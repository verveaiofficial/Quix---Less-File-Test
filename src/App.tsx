        ...
        <div className="drawer-inner">
          ...
          <div className="drawer-scroll">
            ...
            {session ? (
              ...
              <div className="hist-empty">Sign in to save and search your chat history.</div>
            )}
          </div>
        </div>
...
.limit-fill { height: 100%; border-radius: 3px; background: linear-gradient(90deg, #6e5fff, #00f2ff); transition: width .3s ease; }
      ...
      <div id="settings-screen" className={settingsOpen ? "show" : ""}>
        ...
        <div className="set-body">
          ...
          <div className="set-section">
            ...
            <div className="mem-empty">Limits reset at midnight UTC. When a model runs out, Quix auto-switches to the next available one.</div>
          </div>
