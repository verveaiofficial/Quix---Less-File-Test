  ...
  return (
    <div className="file-card" onClick={() => openFile(fid)}>
      <span className="fc-icon">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>
      </span>
      ...
      <span className="fc-actions">
        ...
        <button className="fc-btn" aria-label="Preview" onClick={(e) => { e.stopPropagation(); previewFile(code, lang); }}>
...
function MessageList() {
  ...
  useEffect(() => {
    ...
    if (el) {
      const top =
        el.getBoundingClientRect().top - c.getBoundingClientRect().top + c.scrollTop - 8;
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <div className={`pop-menu ${menuOpen ? "show" : ""}`} style={{ width: 180 }}>
                    ...
                    <div
                      ...
                      onMouseDown={prevent}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>
                      Canvas
                      {canvasOn && (
                        <span
                          className="cv-cross"
            ...
            <div className="action-right">
              {canvasOn && !isDeepThink && (
                <button type="button" className="cv-pill" onClick={() => setCanvasOpen(true)}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z" /></svg>
