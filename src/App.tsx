...
#drawer { position: fixed; top: 0; left: 0; height: 100vh; height: 100lvh; width: 280px; background: rgba(20,20,24,0.92); backdrop-filter: blur(20px) saturate(160%); border-right: 1px solid rgba(255,255,255,0.12); z-index: 50; display: flex; flex-direction: column; transform: translate3d(-100%,0,0); will-change: transform; transition: transform .35s cubic-bezier(.25,.46,.45,.94); }
...
export default function App() {
  ...
  const handleSend = async (text: string, attachments: PendingAttachment[]) => {
    ...
    /* ---- Thinking pacing: min 3s visible reasoning, hard cap 20s ---- */
