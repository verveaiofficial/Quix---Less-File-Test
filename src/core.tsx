...
export function saveLocalMessages(msgs: ChatMessage[]) { try { localStorage.setItem(LOCAL_MSG_KEY, JSON.stringify(msgs.slice(-120))); } catch {} }
export function loadLocalMessages(): ChatMessage[] { try { const arr = JSON.parse(localStorage.getItem(LOCAL_MSG_KEY) || "[]"); return Array.isArray(arr) ? arr : []; } catch { return []; } }
