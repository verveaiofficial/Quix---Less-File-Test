...
try {
  const e = env();
  if (e.VITE_SUPABASE_URL && e.VITE_SUPABASE_ANON_KEY) sb = createClient(e.VITE_SUPABASE_URL, e.VITE_SUPABASE_ANON_KEY);
} catch { sb = null; }
...
export const useUIStore = create<any>((set, get) => ({
  drawerOpen: false, authOpen: false, settingsOpen: false, viewMode: "chat",
  fontScale: loadScale(), drawerReturn: false,
...
/* ================= USAGE LIMITS (reset midnight UTC) ================= */
